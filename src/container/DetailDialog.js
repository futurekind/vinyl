            ...
            <Dialog open={open} onDismiss={this.handleDismiss.bind(this)}>
                ...
                <div className={style.footer}>
                    <div className={style.footer__left}>
                        <div className={`${style.btn} ${album.category === 1 ? style.actice : ''}`} onClick={this.handleSetCategory.bind(this, 1)}>
                        ...
                        <div className={`${style.btn} ${album.category === 2 ? style.actice : ''}`}onClick={this.handleSetCategory.bind(this, 2)}>
